  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm font-medium text-slate-500">
            Hệ thống quản lý không gian lưu trữ và mạng lưới kho bãi.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className={`rounded-full border-none px-2 py-0.5 text-[10px] font-bold ${
                    wh.status === 'active' 
        ...
        <button className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 transition-all hover:border-indigo-400 hover:bg-indigo-50/30 dark:border-slate-800">
