  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4 text-center dark:bg-slate-950">
      <div className="relative mb-8">
        <h1 className="text-9xl font-semibold text-indigo-600/10 dark:text-indigo-500/10">
          404
        </h1>
        <div className="absolute inset-0 flex items-center justify-center">
          <HelpCircle className="size-24 text-indigo-600 dark:text-indigo-400" />
        </div>
      </div>

      <h2 className="mb-2 text-3xl font-semibold text-slate-900 dark:text-white sm:text-4xl">
