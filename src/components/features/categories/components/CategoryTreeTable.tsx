  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900 overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <div role="tree" aria-label="Cây nhóm và loại hàng" className="min-w-180">
          {isLoading ? (
                    ...
                    <div className="flex min-w-0 items-stretch">
                      <div className="flex shrink-0 self-stretch" aria-hidden>
                        {Array.from({ length: treeDepth }).map((_, railIdx) => (
                          <div key={railIdx} className="flex w-8 shrink-0 justify-center self-stretch">
                    ...
                    <div className="flex justify-end">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-48 rounded-xl">
                          ...
                          <DropdownMenuItem className="rounded-lg" render={<Link href={`/categories/${cat.id}`} />}>
