    ...
    >
      ...
      <div className="mx-4 mb-2 rounded-xl border border-slate-200 bg-slate-50/70 px-3 py-2.5 group-data-[collapsible=icon]:hidden dark:border-slate-800 dark:bg-slate-900/60">
        <div className="flex items-center justify-between">
          <p className="text-xs font-semibold text-slate-800 dark:text-slate-200">Kho trung tâm</p>
        ...
        <p className="mt-1 text-[11px] text-slate-500">Cập nhật đồng bộ theo thời gian thực</p>
      </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  childActive && "bg-indigo-50 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-300"
                )}
              >
                <Dot className={cn("mr-1.5 h-4 w-4", childActive ? "text-indigo-500" : "text-slate-300")} />
